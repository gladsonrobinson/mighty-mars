                  ...
                  <div className="block-content">
                    <div className="post-feed">
                      ...
                      <article key={post_idx} className="post">
                        ...
                        <Link className="post-thumbnail" to={safePrefix(_.get(post, 'url'))}><img className="thumbnail" src={safePrefix(post.frontmatter.thumb_img_path)} alt={post.frontmatter.title} /></Link>
                        }
